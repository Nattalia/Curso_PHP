...
try {
  require_once "../../../public/google-api-php-client/examples/adsense/AdSenseAuth.php";
  require_once "../../../public/google-api-php-client/examples/adsense/BaseExample.php";
  require_once "../../../public/google-api-php-client/examples/adsense/htmlHelper.php";
} catch (Exception $e) {
