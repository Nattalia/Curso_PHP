...
try {
  require_once "../../../public/google-api-php-client/examples/adsensehost/AdSenseHostAuth.php";
  require_once "../../../public/google-api-php-client/examples/adsensehost/BaseExample.php";
  require_once "../../../public/google-api-php-client/examples/adsensehost/htmlHelper.php";
} catch (Exception $e) {
