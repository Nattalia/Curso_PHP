 ...
 */
require_once '../../../public/google-api-php-client/src/Google_Client.php';
require_once '../../../public/google-api-php-client/examples/analytics/demo/storage.php';
require_once '../../../public/google-api-php-client/examples/analytics/demo/authHelper.php';
...
if ($_GET['action'] == 'revoke') {
  ...
  if ($authHelper->isAuthorized()) {
    ...
    if ($_GET['demo'] == 'hello') {
      ...
      require_once '../../../public/google-api-php-client/examples/analytics/demo/helloAnalyticsApi.php';
      ...
      require_once '../../../public/google-api-php-client/examples/analytics/demo/managementApiReference.php';
