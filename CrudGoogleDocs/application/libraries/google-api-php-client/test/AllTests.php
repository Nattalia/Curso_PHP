...
require_once '../../../public/google-api-php-client/test/BaseTest.php';
require_once 'adsense/AdsenseTest.php';
require_once '../../../public/google-api-php-client/test/general/GeneralTests.php';
require_once '../../../public/google-api-php-client/test/tasks/AllTasksTests.php';
require_once '../../../public/google-api-php-client/test/pagespeed/AllPageSpeedTests.php';
require_once '../../../public/google-api-php-client/test/urlshortener/AllUrlShortenerTests.php';
require_once '../../../public/google-api-php-client/test/plus/PlusTest.php';
